                    ...
                    <div class="row align-items-center h-100">
                        <div class="col-lg-12 order-0 order-lg-1 h-100 ">
                            <div class="slide-img h-100">
                                <img class="img-fluid w-100 h-100" style="object-fit:contain;" src="assets/banner1.jpeg" alt="Slider"/>
                            </div>
                        </div>
                    </div>
                </div>
...
{{--             <div class="slider-slide-item bg-img">
    ...
    <div class="products-area-wrapper mt-3 mb-5">
        <div class="container container-wide">
            <div class="row mb-3">
                <div class="col-lg-5 m-auto text-center">
                    <div class="d-flex align-items-center ">
                        <img src="assets/adzone.jpeg" class=" img-fluid w-25 me-2" alt="">
                        <p>— ის ბრენდის პრემიუმ კლასის ვიდეო რეგისტრატორები</p>
                    </div>
                </div>
            </div>
{{--             <div class="row">
